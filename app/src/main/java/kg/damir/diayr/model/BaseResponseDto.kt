...
import kg.cdt.diyar_guest.data.network.model.SliderListDto
import kg.damir.diayr.data.network.model.GuestDto
import kg.damir.diayr.data.network.model.MenuCategoryDto
import kg.damir.diayr.data.network.model.AboutUsClientDto
import kg.damir.diayr.data.network.model.MenuClientDto
import kg.damir.diayr.data.network.model.NewsClientDto
import kg.damir.diayr.data.network.model.OrdersClientDto
import kg.damir.diayr.data.network.model.OrdersHistoryClientDto
import kg.damir.diayr.data.network.model.StreetsDbDto
import kg.damir.diayr.data.network.model.StreetsNumberDto
import kg.damir.diayr.data.network.model.WorkTimeDto
